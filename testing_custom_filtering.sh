...
folder_name=output_v_${version}_t_${type}_p_${preprocessing}_c_${confidence}_nc_${number_centers}_adm_${average_distance_multiplier}_cl_${coarse_level}_ic_${index_coarse_feats}
file_name=TestData/v_${version}_t_${type}_p_${preprocessing}_c_${confidence}_nc_${number_centers}_adm_${average_distance_multiplier}_cl_${coarse_level}_ic_${index_coarse_feats}.txt
