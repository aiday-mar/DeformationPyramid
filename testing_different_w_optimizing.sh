...
for w_reg in ${w_reg_list[@]}; do
    for w_cd in ${w_cd_list[@]}; do
		...
		python3 ../../code/sfm/python/graphics/mesh/compute_pointcloud_rmse_ir.py --final="TestData/PartialDeformed/output_${w_reg}_${w_cd}/result.ply" --initial1='TestData/PartialDeformed/020_0.ply' --initial2='TestData/PartialDeformed/104_1.ply' --matches='PartialDeformed/020_104_0_1.npz' --part1="TestData/PartialDeformed/020_0_se4.h5" --part2="TestData/PartialDeformed/104_1_se4.h5" --save_partial_path="TestData/PartialDeformed/020_041_matched" >> TestData/PartialDeformed/output_${w_reg}_${w_cd}/result.txt
