...
filename=Testing/all/test_astrivis_partial_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_levels_${n_deformed_levels}_knn_${knn_matching}.txt
folder_name=output_partial_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_levels_${n_deformed_levels}_knn_${knn_matching}
rm ${filename}
touch ${filename}
