...
filename=Testing/all/test_astrivis_full_non_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_custom_nc_${number_centers}_adm_${average_distance_multiplier}.txt
folder_name=output_full_non_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_custom_nc_${number_centers}_adm_${average_distance_multiplier}
rm ${filename}
touch ${filename}
