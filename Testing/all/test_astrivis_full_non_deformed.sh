...
filename=Testing/all/test_astrivis_full_non_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_levels_${n_non_deformed_levels}_knn_${knn_matching}.txt
folder_name=output_full_non_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_levels_${n_non_deformed_levels}_knn_${knn_matching}
rm ${filename}
touch ${filename}
