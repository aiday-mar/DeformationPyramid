...
filename=Testing/all/test_astrivis_full_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_custom.txt
folder_name=output_full_deformed_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_custom
rm ${filename}
touch ${filename}
