...
def plot_across_types(type, number, partial1, partial2):
    ...
    partial_deformed = data_file('Testing/all/test_astrivis_full_non_deformed_pre_' + preprocessing + '_' + feature_extractor + '.txt', deformed =False)
    partial_deformed = retrieve_type(partial_deformed, type, partial1, partial2)
    full_non_deformed = data_file('Testing/all/test_astrivis_partial_deformed_pre_' + preprocessing + '_' + feature_extractor + '.txt', deformed =True)
