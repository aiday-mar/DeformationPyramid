...
file="Testing/samples/testing_w_${type}.txt"
rm ${file} 
touch ${file}
...
if [ $type == "kpfcn" ]; then
    ...
    for w_reg in ${w_reg_list[@]}; do
        for w_cd in ${w_cd_list[@]}; do
            ...
            echo "w_cd ${w_cd}" >> ${file}
            folder=output_${w_reg}_${w_cd}_${type}
            ...
            python3 ../../code/sfm/python/graphics/mesh/compute_pointcloud_rmse_ir.py --input1="TestData/FullDeformed/model${k}/${folder}/result.ply" --input2="TestData/FullDeformed/model${k}/104.ply" --matches="TestData/FullDeformed/model${k}/020_104.npz" >> ${file}
            fi
            ...
            python3 ../../code/sfm/python/graphics/mesh/compute_pointcloud_rmse_ir.py --final="TestData/PartialDeformed/model${k}/${folder}/result.ply" --initial_1="TestData/PartialDeformed/model${k}/020_0.ply" --initial_2="TestData/PartialDeformed/model${k}/104_1.ply" --matches="TestData/PartialDeformed/model${k}/020_104_0_1.npz" --part1="TestData/PartialDeformed/model${k}/020_0_se4.h5" --part2="TestData/PartialDeformed/model${k}/104_1_se4.h5" --save_partial_path="TestData/PartialDeformed/model${k}/020_041_0_1_matched.ply" >> ${file}
            fi
