...
def mesh_criterion_boundary_detection(filename, num):
    ...
    o3d.io.write_triangle_mesh('Testing/exterior_boundary_detection_initial_experimentation/model' + num + '_mesh.ply', mesh)
    print(mesh)
    ...
    o3d.io.write_point_cloud('Testing/exterior_boundary_detection_initial_experimentation/mesh_criterion_' + num + '.ply', final_pcd)
