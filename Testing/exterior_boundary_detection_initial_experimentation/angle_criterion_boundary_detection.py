...
def get_angle_criterion_mask(file_path, num, use_proba = False):
    ...
    if use_proba:
        o3d.io.write_point_cloud('Testing/exterior_boundary_detection_initial_experimentation/angle_criterion_' + num + '_' + number1 + '_' + number2 + '_' + number3 + '_proba.ply', final_pcd)
    else:
        o3d.io.write_point_cloud('Testing/exterior_boundary_detection_initial_experimentation/angle_criterion_' + num + '_' + number1 + '_' + number2 + '_' + number3 + '_norm.ply', final_pcd)
