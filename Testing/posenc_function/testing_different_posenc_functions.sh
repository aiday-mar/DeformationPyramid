...
if [ $type == "kpfcn" ]; then
        ...
        for posenc_function in ${posenc_functions_list[@]}; do
                ...
                folder=posenc_function_${posenc_function}_${type}
                ...
                python3 eval_supervised_astrivis.py --config=config/${config} --s="PartialDeformed/model${k}/020_0.ply" --t='PartialDeformed/104_1.ply' --source_trans='PartialDeformed/020_0_se4.h5' --target_trans='PartialDeformed/104_1_se4.h5' --matches='PartialDeformed/020_104_0_1.npz' --output="PartialDeformed/${folder}/result.ply" --output_trans="PartialDeformed/${folder}/result_se4.h5" --intermediate_output_folder="PartialDeformed/${folder}/" --base='/home/aiday.kyzy/code/DeformationPyramid/TestData/' --posenc_function=${posenc_function} --print_keypoints >> ${file}
                if [ "$?" != "1" ]; then
...
if [ $type == "fcgf" ]; then
        ...
        for posenc_function in ${posenc_functions_list[@]}; do
                ...
                echo 'Partial Deformed' >> ${file}
                python3 eval_supervised_astrivis.py --config=config/${config} --s="PartialDeformed/model${k}/020_0.ply" --t='PartialDeformed/104_1.ply' --s_feats="PartialDeformed/model${k}/020_0_fcgf.npz" --t_feats='PartialDeformed/104_1_fcgf.npz' --source_trans='PartialDeformed/020_0_se4.h5' --target_trans='PartialDeformed/104_1_se4.h5' --matches='PartialDeformed/020_104_0_1.npz' --output="PartialDeformed/${folder}/result.ply" --output_trans="PartialDeformed/${folder}/result_se4.h5" --intermediate_output_folder="PartialDeformed/${folder}/" --base='/home/aiday.kyzy/code/DeformationPyramid/TestData/' --posenc_function=${posenc_function} --preprocessing=${preprocessing} --print_keypoints >> ${file}
                if [ "$?" != "1" ]; then
                python3 ../../code/sfm/python/graphics/mesh/compute_relative_transformation_error.py --part1="TestData/PartialDeformed/020_0_se4.h5" --part2="TestData/PartialDeformed/104_1_se4.h5" --pred="TestData/PartialDeformed/${folder}/result_se4.h5" >> ${file}
                python3 ../../code/sfm/python/graphics/mesh/compute_pointcloud_rmse_ir.py --final="TestData/PartialDeformed/${folder}/result.ply" --initial_1='TestData/PartialDeformed/020_0.ply' --initial_2='TestData/PartialDeformed/104_1.ply' --matches='TestData/PartialDeformed/020_104_0_1.npz' --part1="TestData/PartialDeformed/020_0_se4.h5" --part2="TestData/PartialDeformed/104_1_se4.h5" --save_final_path="TestData/PartialDeformed/${folder}/final.ply" --save_destination_path="TestData/PartialDeformed/${folder}/destination.ply" >> ${file}
                fi
