...
then
    ...
    then
        ...
        do
            ...
            folder_name=output_lepard_default_pre_${preprocessing}_${type}_td_${td}_current_deformation
            file_name=Testing/custom_filtering/output_lepard_default_pre_${preprocessing}_${type}_td_${td}_current_deformation_model_${k}.txt
            ...
            then
                ...
                if [ "$?" != "1" ]; then
                    ...
                    rm "${base}/PartialDeformed/model${k}/${folder_name}/current_deformation.ply"
            ...
            then
                ...
                if [ "$?" != "1" ]; then
                    ...
                    rm "${base}/FullDeformed/model${k}/${folder_name}/current_deformation.ply"

                    python3 ../../code/sfm/python/learning/fusion/fusion_cli.py \
                    --file1="${base}/FullDeformed/model${k}/020.ply" \
            ...
            folder_name=output_outlier_rejection_default_pre_${preprocessing}_${type}_td_${td}_current_deformation
            file_name=Testing/custom_filtering/output_outlier_rejection_default_pre_${preprocessing}_${type}_td_${td}_current_deformation_model_${k}.txt
