...
filename=Testing/all/test_astrivis_partial_deformed_current_deformation_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}.txt
	...
	do
		...
		for i in $(seq 0 $end); do
			...
			for j in $(seq $start $end); do
				...
				--file1="model${k}/transformed/${file_number1}_0.ply" \
				--file2="model${k}/transformed/${file_number2}_1.ply" \ 
