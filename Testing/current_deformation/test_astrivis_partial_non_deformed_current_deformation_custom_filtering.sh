...
if [ "$one_model" == "False" ] ; then
	filename=Testing/current_deformation/test_astrivis_partial_non_deformed_current_deformation_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_knn_${knn_matching}_conf_${confidence_threshold_name}_custom_nc_${number_centers}_adm_${average_distance_multiplier}.txt
	folder_name=output_partial_non_deformed_deformed_current_deformation_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_knn_${knn_matching}_conf_${confidence_threshold_name}_custom_nc_${number_centers}_adm_${average_distance_multiplier}
fi

if [ "$one_model" == "True" ] ; then
	filename=Testing/current_deformation/test_astrivis_partial_non_deformed_current_deformation_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_knn_${knn_matching}_conf_${confidence_threshold_name}_custom_nc_${number_centers}_adm_${average_distance_multiplier}_one_model_${model_numbers[0]}.txt
	folder_name=output_partial_non_deformed_deformed_current_deformation_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}_knn_${knn_matching}_conf_${confidence_threshold_name}_custom_nc_${number_centers}_adm_${average_distance_multiplier}
fi
