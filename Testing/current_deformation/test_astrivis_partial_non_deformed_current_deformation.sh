...
filename=Testing/all/test_astrivis_partial_non_deformed_current_deformation_pre_${preprocessing}_${type}_td_${training_data}_e_${epoch}.txt
...
if [ $type == "kpfcn" ]; then
    ...
    do
        ...
        --file1="model${k}/transformed/mesh_transformed_0.ply" \
        --file2="model${k}/transformed/mesh_transformed_1.ply" \
