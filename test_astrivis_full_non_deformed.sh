...
do
    ...
    python3 ../../code/sfm/python/graphics/mesh/compute_pointcloud_rmse_ir.py --input1="${base}/model${k}/output/0_1.ply" --input2="${base}/model${k}/mesh_transformed_1.ply" --matches="${base}/model${k}/0_1.npz"
