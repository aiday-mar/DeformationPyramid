...
for i in $(seq 0 $end); do
	...
	for j in $(seq $start $end); do
        ...
        python3 ../../code/sfm/python/graphics/mesh/compute_pointcloud_rmse_ir.py --input1="${base}/model${k}/output/${file_number1}_${file_number2}.ply" --input2="${base}/model${k}/transformed/${file_number2}.ply" --matches="${base}/model${k}/matches/${file_number1}_${file_number2}.npz"
