...
print('Minimum attained for : ', files[RMSE_full_deformed_index])
...
print('Minimum attained for : ', files[RMSE_full_non_deformed_index])
...
print('Minimum attained for : ', files[RMSE_partial_deformed_index])
...
print('Minimum attained for : ', files[RMSE_partial_non_deformed_index])