...
if __name__ == "__main__":
    ...
    for c_iter in tqdm(range(num_iter)):
        ...
        """predict landmarks"""
        ldmk_s, ldmk_t, inlier_rate, inlier_rate_2 = ldmk_model.inference (inputs, s_feats = args.s_feats, t_feats = args.t_feats, base = args.base, reject_outliers=config.reject_outliers, inlier_thr=config.inlier_thr, timer=timer)
